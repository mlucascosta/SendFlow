<section class="grid gap-6">
  ...
  <div class="surface-card overflow-hidden">
    <div class="border-b border-carbon-border p-4 dark:border-carbon-borderDark lg:p-5">
      <div class="grid gap-3 lg:grid-cols-[1.5fr_repeat(3,minmax(0,1fr))_auto]">
        ...
        <select class="input-field">
          <option>Status IA</option>
          <option>Com resumo</option>
          <option>Spam suspeito</option>
          <option>Sem IA</option>
        </select>
        <select class="input-field">
  ...
  <div class="grid gap-4 md:grid-cols-3">
    <div class="surface-card p-5">
      <p class="text-sm text-carbon-textSubtle dark:text-carbon-textSubtleDark">Resumo automático</p>
      <div class="mt-3 h-16 rounded-2xl skeleton"></div>
    </div>
    <div class="surface-card p-5">
      <p class="text-sm text-carbon-textSubtle dark:text-carbon-textSubtleDark">Classificação</p>
      <div class="mt-3 h-16 rounded-2xl skeleton"></div>
    </div>
    <div class="surface-card p-5">
      <p class="text-sm text-carbon-textSubtle dark:text-carbon-textSubtleDark">Detecção de spam</p>
      <div class="mt-3 h-16 rounded-2xl skeleton"></div>
    </div>
  </div>
</section>
